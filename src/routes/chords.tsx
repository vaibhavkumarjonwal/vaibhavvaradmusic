      ...
      <main className="relative min-h-screen overflow-x-hidden bg-background pt-28 text-foreground">
        ...
        <div className="mx-auto max-w-7xl px-6 py-12">
          ...
          <div className="glass mt-10 grid gap-10 rounded-3xl p-6 md:grid-cols-[340px_1fr] md:p-8">
            <img src={cover} alt="Tum Aaye Ho Artwork" className="w-full rounded-2xl shadow-2xl" />
            ...
            <div className="flex flex-col justify-center">
              ...
              <h1 className="mt-6 font-display text-6xl font-black">Tum Aaye Ho</h1>

              <p className="mt-3 text-lg text-muted-foreground">by vaibhavvaradmusic</p>
          ...
          <div ref={toolbarRef} className="mt-6">
            ...
            <div className={toolbarFixed ? "fixed top-24 left-0 right-0 z-50" : ""}>
          ...
          <div className="glass mt-8 rounded-3xl p-8">
            <SongRenderer transpose={transpose + DEFAULT_TRANSPOSE} fontSize={fontSize} />
          </div>
        </div>
      </main>
