...
export const site = {
  ...
  releaseCountdown: {
    ...
    cta: {
      label: "Pre-save",
      href: "https://open.spotify.com/track/1sQfVsiDskUJoDn1bQBIGj?si=WF5mZHUiQ-e6I-jTrmZoBg&utm_source=copy-link",
    },
    liveLabel: "Live Now",
  },
  hero: {
  ...
  latest: {
    ...
    cover: cover1,
    description:
      "The lead single from our upcoming Song — a cinematic blend of Indian pop and electronic textures.",
    previewUrl: mp3,
    links: [
      {
        name: "Spotify",
      ...
      {
        name: "Apple Music",
        href: "https://music.apple.com/in/album/tum-aaye-ho/6790352769?i=6790352779",
      },
      { name: "YouTube Music", href: "https://music.youtube.com/watch?v=5xFWCxTY88E" },
      {
        name: "Amazon Music",
        href: "https://music.amazon.in/tracks/B0H8PBBBXZ?marketplaceId=A21TJRUUN4KGV&musicTerritory=IN&ref=dm_sh_scvGHOsS368CrjfX8dZdDa5TE",
      },
      { name: "JioSaavn", href: "https://www.jiosaavn.com/song/tum-aaye-ho/HyZcdhZyRWE" },
      // { name: "Gaana", href: "" },
      // { name: "Wynk", href: "" },
  ...
  events: [
    {
      title: "Neon Monsoon Launch",
      city: "Mumbai · Antisocial",
      date: "2026-04-18T20:00:00",
      type: "Launch",
    },
    {
      title: "NH7 Weekender",
      city: "Pune · Laxmi Lawns",
  ...
  socials: [
    ...
    "SoundCloud",
    "Bandcamp",
    /*"TikTok", "Twitter", "Discord","WhatsApp","Telegram","Website","Linktree"*/
    ,
  ],
  ...
  media: [
    ...
    {
      source: "Homegrown",
      title: "AURORA//SIGNAL are quietly redefining the scene",
      date: "Feb 2026",
    },
  ...
  timeline: [
    ...
    {
      year: "2024",
      title: "EP Announcement",
      body: "Signed a distribution deal with a global partner.",
    },
  ...
  faq: [
    {
      q: "How can we book you for a show?",
      a: "Reach out via the booking form or email varadvaibhavmusic@gmail.com with dates, venue and expected audience size.",
    },
    {
      q: "Do you take collaboration requests?",
      a: "Yes — send us a note through the collaboration form with links to your work.",
    },
    {
      q: "Where can I stream your music?",
      a: "Everywhere — Spotify, Apple Music, YouTube Music, JioSaavn, Gaana, Amazon Music and more.",
    },
