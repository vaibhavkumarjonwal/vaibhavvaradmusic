...
export const site = {
  ...
  latest: {
    ...
    links: [
      ...
      { name: "Apple Music", href: "https://music.apple.com/in/album/tum-aaye-ho/6790352769?i=6790352779" },
  ...
  socials: [
    "Spotify","Apple Music","YouTube","Instagram","Facebook","Threads","Amazon Music","JioSaavn","Gaana","Wynk","SoundCloud","Bandcamp",
